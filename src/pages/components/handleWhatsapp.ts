...
export const handleWhatsapp = async (
  ...
  const text = [
    ...
    "",
    "Merupakan suatu kebahagiaan bagi kami apabila Bapak/Ibu/Saudara/i berkenan untuk hadir dan memberikan restu kepada anak kami dalam acara khitan anak kami.",
    "",
